...
botaoFiltrar.addEventListener('click', function () {
    ...
    /* passo 4 - para cada carta, verificar se ela deve ser mostrada ou escondida nos filtros que a pessoa digitou */
    ...
    cartas.forEach(function (carta) {
        ...
        if (temFiltroDeCategoria && cartaNaoBateComFiltroDeCategoria) {
            mostrarCarta = false; // Se a categoria não corresponder, não mostrar a carta
        }
        ...
        if (temFiltroDePreco && cartaNaoBateComFiltroDePrecoMaximo) {
            mostrarCarta = false; // Se o preço da carta for maior que o máximo selecionado, não mostrar a carta
        }
